...
//   const followedUserDocument = db.collection('users').doc(req.params.userHandle)
//   .collection('followers').where('userHandle', '==', req.user.handle).limit(1);
...
//           await db.collection('users').doc(req.params.userHandle).collection('followers').add({
//             userHandle: req.user.handle
//           });
//           await db.collection('users').doc(req.user.handle).collection('following').add({
...
//           return res.json('Succesfully followed user');
//         }
//       });
//     })
//     .catch(err => {
...
//   const followedUserDocument = db.collection('users').doc(req.params.userHandle)
//   .collection('followers').where('userHandle', '==', req.user.handle).limit(1);
//   let followedUserDocumentId;

//   const followingUser = db.collection('users').doc(req.user.handle);
//   const followingUserDocument = db.collection('users').doc(req.user.handle)
//   .collection('following').where('userHandle', '==', req.params.userHandle).limit(1);
//   let followingUserDocumentId;
...
//       }
//       followerCount = doc.data().followerCount;
//       return followingUserDocument.get()
//     })
//     .then(data => {
//       if(data.empty) {
//         return res.status(400).json({ error: 'Not yet following user' });
//       }
//       followingUserDocumentId = data.docs[0].id;
...
//             return followedUserDocument.get()
//             .then(data => {
//               followedUserDocumentId = data.docs[0].id;
//               return db.collection('users').doc(req.user.handle)
//               .collection('following').doc(followingUserDocumentId).delete();
//             })
//             .then(() => {
//               return db.collection('users').doc(req.params.userHandle)
//               .collection('followers').doc(followedUserDocumentId).delete()
//             })
//             .then(() => {
//               return followedUser.update({ followerCount: followerCount - 1 });
//             })
//             .then(() => {
//               return followingUser.update({ followingCount: followingCount - 1 });
//             })
//             .then(() => {
...
//   const followers = [];
//   db.collection('users').doc(req.params.userHandle).collection('followers').get()
//     .then(data => {
//       data.forEach(doc => {
//         followers.push(doc.data().userHandle);
//       })
...
// exports.getFollowing = (req, res) => {
//   const following = [];
//   db.collection('users').doc(req.params.userHandle).collection('following').get()
//     .then(data => {
//       data.forEach(doc => {
//         following.push(doc.data().userHandle);
//       })
//       return res.json(following);
//     })
//     .catch(err => {
